...
当前已实现：
- **⛏️ Diamond Mine（钻石矿工）** — 3×3 矿墙，9 块砖中寻找对应中文释义的英文词（每面 2 个目标，最多 5 面墙）。词义识别训练。
- **🛠️ Crafting Table（工作台）** — 点击字母方块拼出目标单词（含干扰字母）。拼写训练。
...
- **Minecraft 像素字体**（Press Start 2P）用于标题/HUD，中文用 Noto Sans SC
